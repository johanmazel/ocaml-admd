...
(* OASIS_START *)
(* DO NOT EDIT (digest: 7ab0b611d0c29a23ab6901a28070a6d0) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          authors = ["Johan Mazel"];
          homepage = None;
          synopsis = "A pure OCaml library to read and write Admd XML files.";
          description = None;
          categories = [];
                   ...
                   },
                   {
                      lib_modules =
                        [
                           ...
                           "Dataset";
                           "Transport_protocol";
                           "Transport_protocol_data_structures";
                           "Myxml";
                           "Xml_utils";
                           "Xmlm_utils";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\220\138\030\149<\163\220nN.\167Y\200\253\161\189";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
